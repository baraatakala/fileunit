...
Write-Host "✅ Deployment initiated! Check Render dashboard for progress." -ForegroundColor Green
Write-Host "🔗 Your site: https://file-tracking-1.onrender.com" -ForegroundColor Cyan
